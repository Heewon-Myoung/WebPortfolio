...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Arita+Dotum:wght@400;700&display=swap" rel="stylesheet">
    <style>
        body {
        ...
        header {
            background: #4caf50 url('https://www.transparenttextures.com/patterns/tiny-grid.png') repeat;
            padding: 20px 0;
        ...
        @keyframes glitter {
            0% { text-shadow: 0 0 5px rgb(53, 172, 2); }
            50% { text-shadow: 0 0 20px rgb(53, 172, 2), 0 0 30px rgb(53, 172, 2), 0 0 40px rgb(53, 172, 2); }
    ...
    <script>
        document.querySelectorAll('.portfolio-item h3').forEach(item => {
            item.addEventListener('click', () => {
                ...
                document.querySelectorAll('.portfolio-item p, .portfolio-item img, .portfolio-item small').forEach(p => p.style.display = 'none');
